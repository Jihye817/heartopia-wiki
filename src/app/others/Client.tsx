...
// Types
// ─────────────────────────────────────────────
export interface OthersSubcategory {
  href: string;
  emoji: string;
...
export interface OthersClientProps {
...
// Client Page
// ─────────────────────────────────────────────
export function OthersClient({ subcategories }: OthersClientProps) {
    ...
    >
      <div className="mx-auto max-w-[1100px]">
        ...
        >
          ...
          <span style={{ color: "#6b4a7a" }}>기타 수집</span>
        </nav>
        ...
        <div className="mb-11">
          ...
          <p className="mt-1 text-sm" style={{ color: "#8a6898" }}>
            맵에서 채집·획득할 수 있는 생산품 등 기타 수집 정보를 확인할 수
            있어요.
          </p>
          <div className="mt-3 flex flex-wrap gap-2">
            <span
              className="inline-flex items-center gap-1 rounded-full border border-slate-200 px-3 py-1 text-xs font-bold text-slate-600"
        ...
        <div className="mb-4 flex items-baseline justify-between">
          ...
          <span
            ...
            style={{
              background: "rgba(123,143,163,0.12)",
              borderColor: "rgba(123,143,163,0.35)",
              color: "#5a6f82",
            }}
          >
